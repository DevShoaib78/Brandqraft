...
const testimonials = [
  {
    id: 1,
    name: "Razeen Abdullah",
    role: "Founder, CyFi",
    content: "Working with BrandQraft transformed our entire brand identity. They didn't just deliver a logo—they gave us a complete visual language that resonates with our audience. Our customer engagement increased significantly within three months.",
    rating: 5,
  },
  {
    id: 2,
    ...
    role: "Founder, Hasco",
    content: "The team at BrandQraft understood our vision from day one. Their strategic approach to digital marketing helped us scale from a local startup to a recognized brand. The ROI has been exceptional.",
    rating: 5,
  },
  {
    id: 3,
    name: "Razeen Abdullah",
    role: "Founder, Mubadara",
  ...
  {
    id: 6,
    name: "Abdullah Quadri",
    role: "Founder, 4 Arms Syndicate",
  ...
  },
  {
    id: 7,
    name: "Yousuf",
    role: "Founder, Saratoga",
    content: "BrandQraft brought clarity and vision to our brand from the very start. Their ability to translate our ideas into a cohesive, premium identity has been a game changer for our business.",
    rating: 5,
  },
];
