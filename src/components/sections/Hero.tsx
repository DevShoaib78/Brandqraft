...
const heroDecorations = [
  // Left side - 3 icons (mobile-first positioning)
  { icon: "004-hummingbird" as const, size: "sm" as const, position: { top: "12%", left: "2%" }, opacity: 1.0, rotate: 15, colorFilter: "black" as const },
  { icon: "023-plane" as const, size: "md" as const, position: { top: "35%", left: "1%" }, opacity: 1.0, rotate: -10, colorFilter: "black" as const },
  { icon: "020-pinwheel" as const, size: "xs" as const, position: { bottom: "20%", left: "3%" }, opacity: 1.0, rotate: 20, colorFilter: "black" as const },

  // Right side - 3 icons (mobile-first positioning)
  { icon: "011-origami" as const, size: "xs" as const, position: { top: "10%", right: "2%" }, opacity: 1.0, rotate: -15, colorFilter: "black" as const },
  { icon: "013-papers" as const, size: "sm" as const, position: { top: "38%", right: "1%" }, opacity: 1.0, rotate: 10, colorFilter: "black" as const },
  { icon: "017-tie" as const, size: "xs" as const, position: { bottom: "22%", right: "3%" }, opacity: 1.0, rotate: -5, colorFilter: "black" as const },
];

export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      {/* Hero Background Image - Pure, no overlays */}
      <div
      ...
      <div className="container relative mx-auto px-6 lg:px-12 pt-32 pb-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="inline-block text-nile-blue/70 text-base md:text-lg font-bold tracking-widest mb-6">
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              >
                {/* Main fill with irregular shape */}
                <path
                  ...
                  opacity="0.88"
                />
                {/* Rough top stroke - multiple passes */}
                <path
                ...
                <path
                  ...
                  fill="none"
                />
                {/* Rough bottom stroke - multiple passes */}
                <path
          ...
          <motion.p
            ...
            className="text-nile-blue text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed font-semibold"
          >
          ...
          >
            {/* Primary CTA - Rectangular with paper-fold */}
            <motion.div
            ...
            {/* Secondary CTA - Rectangular outline with paper-fold */}
            <motion.div
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.97 }}
              className="relative inline-block"
            >
              ...
              >
                {/* Paper-fold effect - enhanced visibility */}
                <div
                  className="absolute top-0 right-0 w-4 h-4"
                  style={{
                    background: "linear-gradient(135deg, rgba(4,62,82,0.8) 0%, rgba(4,62,82,0.6) 100%)",
                    clipPath: "polygon(0 0, 100% 0, 100% 100%)",
                    borderLeft: "1.5px solid rgba(4,62,82,0.9)",
                    borderBottom: "1.5px solid rgba(4,62,82,0.9)",
                  }}
                />
